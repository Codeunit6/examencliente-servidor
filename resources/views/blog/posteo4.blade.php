...
@endsection
@section('header')
<header class="masthead" style="background-image: url('assets/img/portada4.jpg')">
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <img class="img-fluid" src="assets/img/tema4-1.jpg" alt="..." style="width: 100%" />
                ...
                <img class="img-fluid" src="assets/img/tema4-2.jpg" alt="..." style="width: 100%"/>
                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="d-flex justify-content-start">
                            <a class="btn btn-primary text-uppercase justify-content-start" href="{{route('posteo3')}}">🠔 Anterior tema</a>
                        </div>
                    </div>
    
                    <div class="col-sm">
                        <div class="d-flex justify-content-end">
                            <a class="btn btn-primary text-uppercase" href="{{route('posteo5')}}">Siguiente tema →</a>
                        </div>
                    </div>
                </div>
            </div>
